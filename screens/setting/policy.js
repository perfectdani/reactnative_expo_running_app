    ...
    return(
        <View style={styles.bgContainer}>
            ...
            <ScrollView style={styles.docContainer}>
                <Text style={[styles.docTitle, { fontSize: 18 * zoom }]}>RUNROOM PRIVACY POLICY</Text>
                <Text style={[styles.docDate, { fontSize: 16 * zoom }]}>August 1, 2021</Text>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>1. Collected and Disclosed Information</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>2. IP Addresses; Cookies and Other Tracking Technology</Text>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>3. User Generated Content</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>4. E-mails</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={{ marginBottom: 10 }}>
                    <Text style={[styles.docEmphasis, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>{'4.2 Account and Service-Related E-mails' + '\n'}</Text>
                    <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={{ marginBottom: 10 }}>
                    <Text style={[styles.docEmphasis, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>{'4.3 Promotional E-mails' + '\n'}</Text>
                    <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                        ...
                        additional messages in the future by following the instructions in the emails.
                    </Text>
                </Text>
                <Text style={{ marginBottom: 10 }}>
                    <Text style={[styles.docEmphasis, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>{'4.4 Survey E-mails' + '\n'}</Text>
                    <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>5. Social Networking Service</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>6. Third-Party Web Apps</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>7. Security</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>8. Notice to California Residents</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>9. Transfer of Information</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>10. Information Security and Notification</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
                ...
                <Text style={[styles.docSubTitle, { fontSize: 15 * zoom, lineHeight: 19 * zoom }]}>11. RUNROOM Contact</Text>
                <Text style={[styles.docParagraph, { fontSize: 14 * zoom, lineHeight: 18 * zoom }]}>
